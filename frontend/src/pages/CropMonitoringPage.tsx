import cropFieldsImage from '../assets/crop-fields.jpg'
...
function HeaderBanner() {
  return (
    <div className="relative mb-6 h-36 overflow-hidden rounded-[14px] border border-[var(--border-c)]">
      <img src={cropFieldsImage} alt="" className="h-full w-full object-cover" />
      <div className="absolute inset-0 bg-gradient-to-t from-[var(--bg)] via-[var(--bg)]/40 to-transparent" />
      <p className="absolute right-3 bottom-2 text-[10px] text-[var(--text-faint)]">
        Center-pivot irrigation, Saudi Arabia &middot; Landsat 8 / USGS, CC BY 2.0
      </p>
    </div>
  )
}
